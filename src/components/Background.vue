<template>
  <div class="background-wrap" :class="{ shrink: this.$route.path === '/project' }">
    <transition name="page-shift" enter-active-class="animate__animated animate__slideInLeft animate__faster" leave-active-class="animate__animated animate__slideOutRight animate__faster">
    ...
    <div class="navbar" :class="{ 'change-color': menuOpen }">
      <router-link to="/">
        <svg @click="pageShift" xmlns="http://www.w3.org/2000/svg" width="35.31" height="30.665" viewBox="0 0 35.31 30.665" class="logo">
